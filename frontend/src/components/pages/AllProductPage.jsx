...
const AllProductPage = () => {
  ...
  useEffect(() => {
    api
      .get("products") // Fetch all products (ensure this endpoint exists in your backend)
      .then((res) => {
        setProducts(res.data); // Save the fetched products
      })
      .catch((err) => {
            ...
            return (
              ...
              >
                ...
                <div className="text-center flex-1">
                  <h3 className="text-xs font-small !text-gray-900 truncate">
                    {product.name}
                  </h3>
